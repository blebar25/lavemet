document.addEventListener('DOMContentLoaded', () => {
    // Liste des laveries
    const locations = [
        { id: 1, name: '140 rue Peyssonnel', city: 'Marseille', zip: '13002', lat: 43.315067576995325, lng: 5.368565910641101 },
        { id: 2, name: '8-24 rue Jean Jaurès', city: 'Noisy-le-Sec', zip: '93130', lat: 48.890942954519595, lng: 2.454038097383106 },
        { id: 3, name: '111-115 rue d\'Arras', city: 'Faches-Thumesnil', zip: '59115', lat: 50.5947, lng: 3.0745 },
        { id: 4, name: '9 boulevard du Général Leclerc', city: 'Roubaix', zip: '59100', lat: 50.6884194496591, lng: 3.175518926475504 },
        { id: 5, name: '51-55 avenue de la République', city: 'Lomme', zip: '59160', lat: 50.639732, lng: 3.0143242 },
        { id: 6, name: '106 boulevard Marguerite de Rochechouart', city: 'Paris', zip: '75018', lat: 48.88264573524561, lng: 2.3410324685470343 },
        { id: 7, name: '749 Avenue de Dunkerque', city: 'Lomme', zip: '59160', lat: 50.64571551796372, lng: 2.9883897821192673 },
        { id: 8, name: '50 Rue Albert Bailly', city: 'Marcq-en-Baroeul', zip: '59700', lat: 50.67855328403077, lng: 3.092761641815206 },
        { id: 9, name: '94 rue d\'Hurlupin', city: 'Comines', zip: '59760', lat: 50.76332917573262, lng: 3.0104256649694663 },
        { id: 10, name: '66 rue du Bournard', city: 'Colombes', zip: '92700', lat: 48.92286992260521,  lng: 2.2564465349776053 },
        { id: 11, name: '74 cours de la Liberté', city: 'Lyon', zip: '69003', lat: 45.75628605620531, lng: 4.842619025786987 },
        { id: 12, name: '162 Cours du Docteur long', city: 'Lyon', zip: '69003', lat: 45.75285145989091, lng: 4.895053239281455 },
        { id: 13, name: '2 rue David', city: 'Lyon', zip: '69003', lat: 45.75448017108418, lng: 4.867583168116645 },
        { id: 14, name: '5 rue St Gabriel', city: 'Lille', zip: '59000', lat: 50.63761460298308, lng: 3.08651572601484 },
        { id: 15, name: '227 rue Alfred Motte', city: 'Roubaix', zip: '59100', lat: 50.67479076710998, lng: 3.19692376834641 },
        { id: 16, name: '139 rue dauphiné', city: 'Lyon', zip: '69003', lat: 45.75515624266127, lng: 4.875484197247923 },
        { id: 17, name: '14 place gabriel Rambaud', city: 'Lyon', zip: '69001', lat: 45.76799750735213, lng: 4.829173697248448 },
        { id: 18, name: '22 rue du lieutenant colonel Girard', city: 'Lyon', zip: '69007', lat: 45.7376576236299, lng: 4.827467326082895 },
    ...
    const specificImages = {
        ...
        13: [ // David
            'images/David/David-1.jpeg',
            'images/David/David-2.jpeg',
            'images/David/David-3.jpeg',
            'images/David/David-4.jpeg',
            'images/David/David-5.jpeg'
        ],
        14: [ // St_gabriel
        ...
        16: [ // Dauphine
            'images/Dauphine/Dauphine-1.jpeg',
            'images/Dauphine/Dauphine-2.jpeg',
            'images/Dauphine/Dauphine-3.jpeg'
        ],
        17: [ // Rambaud
            'images/Rambaud/Rambaud-1.jpeg',
            'images/Rambaud/Rambaud-2.jpeg',
            'images/Rambaud/Rambaud-3.jpeg',
            'images/Rambaud/Rambaud-4.jpeg'
        ],
        18: [ // Girard
            'images/Girard/Girard-1.jpeg',
            'images/Girard/Girard-2.jpeg',
            'images/Girard/Girard-3.jpeg'
        ]
    };
    ...
    if (container) {
        container.innerHTML = locations.map(location => `
            <div class="laverie-card ${location.id >= 19 ? 'coming-soon-card opacity-50' : ''} bg-gradient-to-b from-blue-50 to-white p-4 rounded-lg shadow-lg relative">
                ${location.id >= 19 ? 
    ...
    locations.forEach(location => {
        // Ne pas ajouter de marqueur pour les futures laveries (ID 16-22)
        if (location.id >= 19) return;
